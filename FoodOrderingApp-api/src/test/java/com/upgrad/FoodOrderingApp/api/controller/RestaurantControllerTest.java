...
//
//    private static final String NON_VEG = "1";
//    private static final String VEG = "0";
//
...
//        final RestaurantEntity restaurantEntity = getRestaurantEntity();
//        when(mockRestaurantService.getAllRestaurantsByName("someRestaurantName"))
...
//        assertEquals(restaurantList.getAddress().getState().getId().toString(), restaurantEntity.getAddressEntity().getState().getUuid());
//
//        verify(mockRestaurantService, times(1)).getAllRestaurantsByName("someRestaurantName");
...
//        when(mockRestaurantService.getAllRestaurantsByName(anyString()))
...
//        verify(mockRestaurantService, times(1)).getAllRestaurantsByName(anyString());
//    }
//
//
...
//        restaurantEntity.setNoOfCustomerRated(200);
